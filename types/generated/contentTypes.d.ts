...
export interface ApiCaliforniaCalifornia extends Schema.SingleType {
  collectionName: 'californias';
  info: {
    singularName: 'california';
    pluralName: 'californias';
...
export interface ApiDisclosureDisclosure extends Schema.SingleType {
...
export interface ApiEConsentEConsent extends Schema.SingleType {
  collectionName: 'e_consents';
  info: {
    singularName: 'e-consent';
    pluralName: 'e-consents';
    displayName: 'E-Consent';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPartnersPartners extends Schema.SingleType {
  collectionName: 'partnerses';
  info: {
    singularName: 'partners';
    pluralName: 'partnerses';
